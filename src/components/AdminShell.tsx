...
const NAV_ITEMS: { to: string; label: string; built: boolean }[] = [
  ...
  { to: "/admin/verification", label: "Verification", built: false },
  { to: "/admin/contracts", label: "Contracts", built: false },
  { to: "/admin/projects", label: "Projects", built: false },
  { to: "/admin/documents", label: "Documents", built: false },
  { to: "/admin/messages", label: "Messages", built: false },
  { to: "/admin/support", label: "Support", built: false },
  ...
  { to: "/admin/audit-log", label: "Audit Log", built: false },
  { to: "/admin/settings", label: "Platform Settings", built: false },
];
