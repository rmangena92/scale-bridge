...
const NAV_ITEMS: { to: string; label: string; built: boolean; part: string }[] = [
  ...
  { to: "/client/milestones", label: "Milestones", built: true, part: "B" },
  { to: "/client/documents", label: "Documents", built: true, part: "B" },
  { to: "/client/approvals", label: "Approvals", built: true, part: "B" },
  { to: "/client/issues", label: "Issues", built: true, part: "B" },
  { to: "/client/variations", label: "Variations", built: true, part: "B" },
  { to: "/client/invoices", label: "Invoices", built: true, part: "B" },
